(jQuery.easing.jswing = jQuery.easing.swing),
  ...
  (function (t, e) {
    "object" == typeof exports
      ? (module.exports = e())
      : "function" == typeof define && define.amd && define("GMaps", [], e),
      (t.GMaps = e());
  })(this, function () {
    ...
    var t = function (t, e) {
      ...
      i = function (t, e) {
        ...
        if (Array.prototype.map && t.map === Array.prototype.map)
          n = Array.prototype.map.call(t, function (t) {
            return (
              (callback_params = s),
              callback_params.splice(0, 0, t),
              e.apply(this, callback_params)
            );
          });
        else
          for (i = 0; o > i; i++)
            (callback_params = s),
              callback_params.splice(0, 0, t[i]),
              n.push(e.apply(this, callback_params));
        return n;
      },
      s = function (t) {
        var e,
      ...
      o = function (t, e) {
        ...
        for (i = 0; i < t.length; i++)
          t[i] instanceof google.maps.LatLng ||
            (t[i].length > 0 && "object" == typeof t[i][0]
              ? (t[i] = o(t[i], e))
              : (t[i] = n(t[i], e)));
        return t;
      },
        ...
        var i = document,
          s = function (e) {
            ...
            for (
              ...
              delete e[c[n]];
            for (
              1 != e.disableDefaultUI && (M = t(M, $)), k = t(M, e), n = 0;
              n < l.length;
              n++
            )
              delete k[l[n]];
            ...
            (this.map = new google.maps.Map(this.el, k)),
              g && (this.markerClusterer = g.apply(this, [this.map]));
            var S = function (t, e) {
              var i = "",
              ...
              if (r("gmaps_context_menu")) {
                ...
                for (n = 0; p > n; n++) {
                  var g = c[n],
                    d = function (i) {
                      i.preventDefault(),
                        s[this.id.replace(t + "_", "")].action.apply(o, [e]),
                        o.hideContextMenu();
                    };
                  google.maps.event.clearListeners(g, "click"),
                    google.maps.event.addDomListenerOnce(g, "click", d, !1);
                }
            ...
            google.maps.event.addListener(this.map, "rightclick", function (t) {
              e.rightclick && e.rightclick.apply(this, [t]),
                void 0 != window.context_menu[o.el.id].map &&
                  o.buildContextMenu("map", t);
            }),
            ...
            var T,
              A = [];
            for (T in this.map)
              "function" != typeof this.map[T] || this[T] || A.push(T);
    ...
    (l.prototype.createControl = function (t) {
      ...
      t.id && (e.id = t.id),
        ...
        t.content &&
          ("string" == typeof t.content
            ...
            : t.content instanceof HTMLElement && e.appendChild(t.content)),
        t.position &&
          (e.position = google.maps.ControlPosition[t.position.toUpperCase()]);
      ...
      (l.prototype.removeControl = function (t) {
        ...
        for (e = 0; e < this.controls.length; e++)
          this.controls[e] == t &&
            ((i = this.controls[e].position), this.controls.splice(e, 1));
        if (i)
      ...
      (l.prototype.createMarker = function (e) {
        ...
        for (var c = 0; c < g.length; c++)
          !(function (t, i, s) {
            e[s] &&
              google.maps.event.addListener(i, s, function (i) {
                i.pixel ||
                  (i.pixel = t.getProjection().fromLatLngToPoint(i.latLng)),
                  e[s].apply(this, [i]);
              });
          })(this.map, l, g[c]);
        return (
          google.maps.event.addListener(l, "click", function () {
            (this.details = s),
              ...
              l.infoWindow &&
                (i.hideInfoWindows(), l.infoWindow.open(i.map, l));
          }),
          google.maps.event.addListener(l, "rightclick", function (t) {
            (t.marker = this),
              e.rightclick && e.rightclick.apply(this, [t]),
              void 0 != window.context_menu[i.el.id].marker &&
                i.buildContextMenu("marker", t);
          }),
          l.fences &&
        ...
        return (
          ...
          (e.draw = function () {
            ...
            (o.style.display = i ? "block" : "none"),
              i || t.show.apply(this, [o]);
          }),
          (e.onRemove = function () {
            var i = e.el;
            t.remove
              ? t.remove.apply(this, [i])
              : (e.el.parentNode.removeChild(e.el), (e.el = null));
          }),
      ...
      (l.prototype.drawPolyline = function (t) {
        ...
        if (i.length)
          if (void 0 === i[0][0]) e = i;
            ...
            for (var s, n = 0; (s = i[n]); n++)
              e.push(new google.maps.LatLng(s[0], s[1]));
        var o = {
          map: this.map,
          path: e,
        ...
        for (
          var r = new google.maps.Polyline(o),
            a = [
              "click",
              "dblclick",
              "mousedown",
        ...
        for (var e = 0; e < this.polylines.length; e++)
          if (this.polylines[e] === t) {
            this.polylines[e].setMap(null),
              ...
              l.fire("polyline_removed", t, this);
            break;
          }
      }),
      ...
      (l.prototype.drawCircle = function (e) {
        (e = t(
          ...
          delete e.lng;
        for (
          var i = new google.maps.Circle(e),
            s = [
              "click",
              "dblclick",
              "mousedown",
      ...
      (l.prototype.drawRectangle = function (e) {
        ...
        e.bounds = i;
        for (
          var s = new google.maps.Rectangle(e),
            n = [
              "click",
              "dblclick",
              "mousedown",
      ...
      (l.prototype.drawPolygon = function (e) {
        var n = !1;
        e.hasOwnProperty("useGeoJSON") && (n = e.useGeoJSON),
          delete e.useGeoJSON,
          (e = t({ map: this.map }, e)),
          0 == n && (e.paths = [e.paths.slice(0)]),
          e.paths.length > 0 &&
            e.paths[0].length > 0 &&
            (e.paths = s(i(e.paths, o, n)));
        for (
      ...
      (l.prototype.addLayer = function (t, e) {
        ...
        switch (t) {
          ...
          case "places":
            if (
              ((this.singleLayers.places = i = new google.maps.places.PlacesService(
                this.map
              )),
              ...
              e.radarSearch && i.radarSearch(s, e.radarSearch),
                e.search && i.search(s, e.search),
                e.nearbySearch && i.nearbySearch(s, e.nearbySearch);
            }
            if (e.textSearch) {
              var n = {
                bounds: e.bounds || null,
        ...
        return void 0 !== i
          ? ("function" == typeof i.setOptions && i.setOptions(e),
    ...
    return (
      (l.prototype.getRoutes = function (e) {
        ...
        var i = {
          ...
          s = t(i, e);
        (s.origin = /string/.test(typeof e.origin)
          ? e.origin
          : new google.maps.LatLng(e.origin[0], e.origin[1])),
          (s.destination = /string/.test(typeof e.destination)
            ? e.destination
        ...
        o.route(s, function (t, i) {
          if (i === google.maps.DirectionsStatus.OK) {
            for (var s in t.routes)
              t.routes.hasOwnProperty(s) && n.routes.push(t.routes[s]);
      ...
      (l.prototype.getElevations = function (e) {
        (e = t({ locations: [], path: !1, samples: 256 }, e)),
          e.locations.length > 0 &&
            ...
            (e.locations = s(i([e.locations], o, !1)));
        var n = e.callback;
        delete e.callback;
        ...
        if (e.path) {
          ...
          delete e.path,
            delete e.samples,
            r.getElevationForLocations(e, function (t, e) {
              n && "function" == typeof n && n(t, e);
            });
      }),
      (l.prototype.cleanRoute = l.prototype.removePolylines),
      (l.prototype.drawRoute = function (t) {
        var e = this;
        this.getRoutes({
          origin: t.origin,
          ...
          callback: function (i) {
            if (i.length > 0) {
              ...
              t.hasOwnProperty("icons") && (s.icons = t.icons),
                e.drawPolyline(s),
      ...
      (l.prototype.travelRoute = function (t) {
        if (t.origin && t.destination)
          this.getRoutes({
            ...
            callback: function (e) {
              if (
                (e.length > 0 && t.start && t.start(e[e.length - 1]),
                e.length > 0 && t.step)
              ) {
                var i = e[e.length - 1];
                if (i.legs.length > 0)
                  for (var s, n = i.legs[0].steps, o = 0; (s = n[o]); o++)
                    (s.step_number = o), t.step(s, i.legs[0].steps.length - 1);
              }
              e.length > 0 && t.end && t.end(e[e.length - 1]);
            },
          });
        else if (t.route && t.route.legs.length > 0)
          for (var e, i = t.route.legs[0].steps, s = 0; (e = i[s]); s++)
            (e.step_number = s), t.step(e);
      }),
      (l.prototype.drawSteppedRoute = function (t) {
        ...
        if (t.origin && t.destination)
          this.getRoutes({
            ...
            callback: function (i) {
              if (
                (i.length > 0 && t.start && t.start(i[i.length - 1]),
                i.length > 0 && t.step)
              ) {
                var s = i[i.length - 1];
                if (s.legs.length > 0)
                  for (var n, o = s.legs[0].steps, r = 0; (n = o[r]); r++) {
                    ...
                    t.hasOwnProperty("icons") && (a.icons = t.icons),
                      e.drawPolyline(a),
                      t.step(n, s.legs[0].steps.length - 1);
                  }
              }
      ...
      (l.prototype.toImage = function (t) {
        var t = t || {},
          e = {};
        if (
          ((e.size = t.size || [this.el.clientWidth, this.el.clientHeight]),
        ...
        if (this.polylines.length > 0) {
          ...
          (e.polyline = {}),
            ...
            (e.polyline.strokeColor = s.strokeColor),
            (e.polyline.strokeOpacity = s.strokeOpacity),
            (e.polyline.strokeWeight = s.strokeWeight);
        }
      ...
      (l.staticMapURL = function (t) {
        function e(t, e) {
          if ("#" === t[0] && ((t = t.replace("#", "0x")), e)) {
            if (
              ((e = parseFloat(e)), (e = Math.min(1, Math.max(e, 0))), 0 === e)
            )
              return "0x00000000";
            (e = (255 * e).toString(16)),
              1 === e.length && (e += e),
        ...
        if ((delete t.polyline, t.center))
          s.push("center=" + t.center), delete t.center;
        else if (t.address) s.push("center=" + t.address), delete t.address;
        else if (t.lat)
          s.push(["center=", t.lat, ",", t.lng].join("")),
            delete t.lat,
            delete t.lng;
        else if (t.visible) {
        ...
        var h = t.size;
        h ? (h.join && (h = h.join("x")), delete t.size) : (h = "630x300"),
          s.push("size=" + h),
          t.zoom || t.zoom === !1 || (t.zoom = 15);
          ...
          for (var g, d, u = 0; (i = o[u]); u++) {
            (g = []),
              i.size && "normal" !== i.size
                ? (g.push("size:" + i.size), delete i.size)
                : i.icon &&
                  (g.push("icon:" + encodeURI(i.icon)), delete i.icon),
              i.color &&
                (g.push("color:" + i.color.replace("#", "0x")), delete i.color),
              i.label &&
                (g.push("label:" + i.label[0].toUpperCase()), delete i.label),
              (d = i.address ? i.address : i.lat + "," + i.lng),
              delete i.address,
              delete i.lat,
              delete i.lng;
            ...
            g.length || 0 === u
              ? (g.push(d),
                (g = g.join("|")),
                s.push("markers=" + encodeURI(g)))
              : ((g = s.pop() + encodeURI("|" + d)), s.push(g));
          }
        if (r)
          for (var u = 0; u < r.length; u++) {
            var f = [];
            r[u].featureType &&
              f.push("feature:" + r[u].featureType.toLowerCase()),
              r[u].elementType &&
                f.push("element:" + r[u].elementType.toLowerCase());
            for (var m = 0; m < r[u].stylers.length; m++)
              for (var _ in r[u].stylers[m]) {
                var y = r[u].stylers[m][_];
                ("hue" == _ || "color" == _) && (y = "0x" + y.substring(1)),
                  f.push(_ + ":" + y);
              }
            var v = f.join("|");
            "" != v && s.push("style=" + v);
        ...
        if (a) {
          if (
            ((i = a),
            (a = []),
            i.strokeWeight && a.push("weight:" + parseInt(i.strokeWeight, 10)),
            i.strokeColor)
          ) {
          ...
          var b = i.path;
          if (b.join) for (var C, m = 0; (C = b[m]); m++) a.push(C.join(","));
          else a.push("enc:" + b);
      ...
      (l.prototype.addMapType = function (t, e) {
        if (
          !e.hasOwnProperty("getTileUrl") ||
          "function" != typeof e.getTileUrl
        )
      ...
      (l.prototype.createPanorama = function (t) {
        return (
          ...
          (this.panorama = l.createPanorama(t)),
      ...
      (l.createPanorama = function (e) {
        ...
        for (
          ...
          delete n[s[o]];
        for (
          var a = new google.maps.StreetViewPanorama(i, n), o = 0;
          o < s.length;
          o++
        )
          !(function (t, i) {
      ...
      (l.on = function (t, e, i) {
        if (-1 == l.custom_events.indexOf(t))
          return (
            e instanceof l && (e = e.map),
            google.maps.event.addListener(e, t, i)
          );
        var s = { handler: i, eventName: t };
        return (
          (e.registered_events[t] = e.registered_events[t] || []),
          e.registered_events[t].push(s),
          s
        );
      }),
      (l.off = function (t, e) {
        -1 == l.custom_events.indexOf(t)
          ? (e instanceof l && (e = e.map),
            google.maps.event.clearListeners(e, t))
          : (e.registered_events[t] = []);
      }),
      (l.fire = function (t, e, i) {
        if (-1 == l.custom_events.indexOf(t))
          ...
          for (var s = i.registered_events[t], n = 0; n < s.length; n++)
            !(function (t, e, i) {
              t.apply(e, [i]);
            })(s[n].handler, i, e);
      }),
